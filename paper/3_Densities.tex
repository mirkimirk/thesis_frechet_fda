...
\begin{figure}[h]
    \centering
    \input{../bld/figures/broken_qdf.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/fixed_qdf.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/naive_trunc_rep_vs_orig.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/trunc_rep_vs_orig.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/1st_modes.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/2nd_modes.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/f_mean_vs_denstimation.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/cs_mean_vs_denstimation.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/comparison_f_cs.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/k_opt_denstimation_histogram.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
...
\begin{figure}[h]
    \centering
    \input{../bld/figures/fve_denstimation.pgf}
    % \resizebox{0.9\textwidth}{!}{\input{../bld/figures/frechet_means.pgf}}
