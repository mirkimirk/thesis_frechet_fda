...
\subsection{Covariance Operator and Covariance Functions}
\label{sec:covs}
...
\begin{definition}[Covariance Operator]
    ...
    \]
\end{definition}
The conditions in this definition are functional analogues of the usual conditions of
...
\end{equation}
where $\gamma(s, t) = \text{Cov}(X(s), X(t)) = \mathbb{E}[(X(s) - \mathbb{E}[X(s)])(X(t) - \mathbb{E}[X(t)])]$.
