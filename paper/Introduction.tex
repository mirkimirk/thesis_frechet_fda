...
foundation for fda and the Fréchet regression framework, Section 3 explains basic fda
concepts. Section 4 discusses density regression and the inadequacy of directly applying
fda methods on the space of densities, along with the transformation approach. Section 5
explains the Fréchet method, with a special focus on our regression context in the Wasserstein
space of distributions. Section 6 illustrates the methods, and compares them in a simulation study.
Section 7 concludes.

The code to this thesis can be found at \url{https://github.com/mirkimirk/thesis_frechet_fda}.
