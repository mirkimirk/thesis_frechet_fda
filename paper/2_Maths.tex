...
\label{sec:hilbert space theory}
...
a Hilbert-Schmidt operator (\citet{WangChiouMüller2016} say because of the integral form,
...
\subsubsection{Operators in Hilbert Spaces}
\label{sec:operators}
Blbalbabla
